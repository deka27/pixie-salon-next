          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="block mb-4 text-base font-semibold text-dimWhite">
                  Contact Us
                </span>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div id="form" className="relative p-8 rounded-lg sm:p-12 bg-dimWhite">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 bg-slate-700 text-white transition rounded hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
